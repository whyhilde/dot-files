...
class Installing:
    ...
    def install_packages():
        intel_input = input("Install drivers for Intel CPU? [Y/n]: ").strip().upper()
        if intel_input == "Y" or intel_input == "":
            ...
            print(
                f"{Cols.WARN}[-] Incorrect input. Skipping the driver installation.{Cols.END}"
            )
    ...
    def change_shell():
        try:
            ...
            if not fish_path:
                ...
                print(f"{Cols.INFO}[+] The shell has been changed successfully.{Cols.END}")
            ...
            if not starship_path:
                ...
                print(f"{Cols.INFO}[+] Starship has been successfully installed.{Cols.END}")
...
ExecStart=-/usr/bin/agetty --autologin {username} --noclear %I $TERM"""
            ...
            print(f"{Cols.INFO}[+] Autologin has been successfully configured.{Cols.END}")
